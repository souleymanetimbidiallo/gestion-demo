<?php
    ...
    //Recuperation des demandes de passeport
    $rows = recupInformations('PASSEPORT');
...
<head>
    ...
    <title>Reponse du passeport</title>
    <link rel="stylesheet" href="../../css/bootstrap.min.css">
</head>
<body>
    <main class="container-fluid mt-3">
        <h1 class="h3 text-center">Liste des demandes de passeport</h1>

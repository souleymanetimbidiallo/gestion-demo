<?php
    ...
    $id_resp = recupIdResponsable('CASIER_JUDICIAIRE');
        ...
        if($nb_ligne == 0){
            ...
            $reference = $_POST['reference'];
                ...
                if($id_citoyen == $id_cit){
                    ...
                    $titrePapier = "casierjudiciaire";
                    $etat = $_POST['type_demande'];
                    $nomColonne = "DATE_EXP_CASIER";
            ...
            <div class="container">
                <div class="row">
                    <div class=" mx-auto offset-1 col-10 p-4 offset-sm-2 col-sm-8 p-sm-4 offset-md-4 col-md-6 offset-lg-4 col-lg-5 mt-4
                        ...
                        <h1 class="h3 text-center text-white">Demande de casier judiciaire</h1> 
